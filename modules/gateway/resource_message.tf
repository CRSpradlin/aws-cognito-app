...
resource "aws_api_gateway_method" "method_post_message" {
  ...
  request_models = {
    "application/json" = aws_api_gateway_model.method_post_message_model.name
  }
}

resource "aws_api_gateway_model" "method_post_message_model" {
  rest_api_id  = aws_api_gateway_rest_api.rest.id
  name         = "MethodPostMessageModel"
...
resource "aws_api_gateway_integration" "lambda_sendMessage_method_post_message_integration" {
  rest_api_id             = aws_api_gateway_rest_api.rest.id
  resource_id             = aws_api_gateway_resource.resource_message.id
...
resource "aws_lambda_permission" "lambda_sendMessage_method_post_message_permission" {
